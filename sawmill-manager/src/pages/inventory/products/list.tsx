...
import { IInventoryFilterVariables, IProductWQuantity, ISawmill } from "../../../interfaces/interfaces";
import { Autocomplete, Avatar } from "@mui/material";
import { Controller } from "react-hook-form";

export const InventoryProductList: React.FC<IResourceComponentsProps> = () => {
    ...
    const columns = React.useMemo<GridColDef<IProductWQuantity>[]>(
        () => [
            ...
            {
                field: "quantity",
                headerName: t("products.fields.quantity"),
                minWidth: 100,
                flex: 1,
                valueGetter: (params) => {
            ...
            {
                field: "value",
                headerName: t("products.fields.value"),
                minWidth: 100,
                flex: 1,
                valueGetter: (params) => {
                    if (params?.row?.price) {
