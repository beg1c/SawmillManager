...
import { CloseOutlined, ForestSharp } from "@mui/icons-material";
import { Autocomplete, Avatar, Input, TextField, Typography } from "@mui/material";
import { Controller, FieldValues, SubmitHandler } from "react-hook-form";
import ImageCrop from "../imageCrop";

export const EditMaterial: React.FC<
...
> = ({
    ...
    const material: IMaterial | undefined = queryResult?.data?.data;
                    ...
                    >
                        ...
                        <FormControl sx={{ width: "100%" }}>
                            ...
                            <label htmlFor="images-input">
                                ...
                                alt="Material image"
                                src={croppedBase64 || material?.photo}
                                >                    
